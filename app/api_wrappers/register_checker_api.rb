...
# The base URL for the calls is configured by +RETROFIT_API_URL+ environment variable.
#
...
class RegisterCheckerApi < BaseApi
  ...
  class << self
    ##
    # Calls +/v1/retrofit/register-csv-from-s3/jobs+ endpoint with +POST+ method
    ...
    ##
    # Calls +/v1/retrofit/register-csv-from-s3/jobs/:job_uuid+ endpoint with +GET+ method
